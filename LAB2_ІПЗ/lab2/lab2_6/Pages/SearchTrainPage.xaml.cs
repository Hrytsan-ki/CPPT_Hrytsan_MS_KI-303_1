...
{
    public partial class SearchTrainPage : Window
    {
        ...
        private void TripsListBox_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            ...
            {
                TrainSeatsPage trainSeatsPage = new TrainSeatsPage(selectedTrip);
                trainSeatsPage.ShowDialog();
            }
        }

        private void RatingClick(object sender, RoutedEventArgs e)
        {
            var ratingPage = new TrainRating();
            ratingPage.Show();
        }
